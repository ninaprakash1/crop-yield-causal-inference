...
Function that runs get_basic_causal_results for each crop type, given another covariate to stratify on so that we can report results on a per-crop basis.
